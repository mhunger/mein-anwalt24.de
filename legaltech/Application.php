...
use legaltech\config\LegaltechContainerConfig;
use legaltech\config\LegaltechTestContainerConfig;
...
class Application {
    ...
    private function bootConfig()
    {
        ...
        $config->merge(new LegaltechContainerConfig());
        if($this->env == Environment::TEST) {
            $config->merge(
                new LegaltechTestContainerConfig()
            );
        }
